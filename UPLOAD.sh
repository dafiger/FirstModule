...
# git add .
# git commit -m "update to FirstModule tag:${UpVersion}"
# git tag ${UpVersion}
# git push
# git push --tags
# pod repo push ${SpecName} FirstModule.podspec --verbose --allow-warnings --use-libraries --use-modular-headers
