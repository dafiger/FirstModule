...
s.version      = '0.0.2'
  ...
  s.homepage     = 'https://github.com/dafiger/FirstModule'
  ...
  s.source       = { :git => 'https://github.com/dafiger/FirstModule.git', :tag => s.version.to_s }
  ...
  # 预编译文件
  s.prefix_header_contents = '#import <UIKit/UIKit.h>', '#import <Foundation/Foundation.h>', '#import "FirstModuleHeader.h"'
  ...
  # 资源文件1
  s.resource_bundles = {
    'FirstModule' => ['FirstModule/Assets/**/*']
  }
  # s.resource_bundles = { 
  #   'FirstModuleResourceBundle' => ['FirstModule/Resource_bundle.xcassets'],
  #   'FirstModuleOtherResources' => ['FirstModule/Resource']
  # }
  ...
  # s.resources  = 'FirstModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}', 'FirstModule/Assets.xcassets'
  # s.resources  = ['FirstModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}']
  # s.resources  = 'FirstModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}'
